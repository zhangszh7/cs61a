...
- 官方文档 [cmdline：python命令行用法](https://docs.python.org/3.9/using/cmdline.html)
  - `python -i`：交互式运行code
  - `python -m doctest`：文档测试，内置模块doctest可以自动扫描文档，运行>>>后面的代码，并检查输出是否等于下面的内容。


直接跟着cs61a学习即可；以下是一些补充/进阶资料，可以考虑在学完后参考：
- [Python 进阶书籍](https://automatetheboringstuff.com/)
- [Corey Schafer](https://www.youtube.com/@coreyms) （大佬，出了很多优秀的教程）

---

#### 实验测试流程
核心测试流程包含两步：解锁(Unlock)和测试(test):
- 写代码前：`python ok -u --local`，测试你是否能读懂代码；
